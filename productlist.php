        	...
        	<div class="product_table">	
			  ...
			  <table width="588" border="0" cellspacing="0" cellpadding="0">
                ...
                <td width="196" align="center">
                    ...
                    <img class="productlistimg" width="100" height="180" src="<? echo(productfolder . $row[$i-1]['productimage']); ?>"/>
					</a>                    
                    </td></tr>
					
                    <tr align="center" height="30px"><td>
                    <div class="textprd nameprd"><? echo($row[$i-1]['productname']); ?></div>
                    </td></tr>
                    <tr align="center"><td>
					<div class="textprd cateprd">
                    Category: 
					<? 
