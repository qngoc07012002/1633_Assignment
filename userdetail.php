	...
	<div class="productlist">
        ...
        <div class="products">
        	...
        	<div class="product_table">	
                ...
                <table class="tabledetail" width="500" border="0" cellspacing="0" cellpadding="0">
                <tr height="20px">
                <td colspan="2"><div class="userdetailcaption"><strong>Personal Details</strong></div></td>
                </tr>
                <tr height="20px">
                ...
                <td colspan="2">
                <input class="button" type="button" value="Continue Shopping" onclick="javascript:window.location='?page=productlist&cart=<? echo($GLOBALS['cart']) ?>'" />&nbsp;<input class="button" type="button" value="View Cart" onclick="javascript:window.location='?page=addcart&cart=<? echo($GLOBALS['cart']) ?>'" />&nbsp;<input class="button" type="submit" value="Update Profile" />&nbsp;<input class="button" type="button" value="Order History" onclick="javascript:window.location='?page=orderhistory&cart=<? echo($GLOBALS['cart']) ?>'" />
                </td>
                </tr>
