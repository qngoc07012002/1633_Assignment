	...
	<div class="productlist">
        ...
        <div class="products">
			  ...
			  <table width="580" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="30px">
                  <td colspan="6" align="right">
                    ...
                    <input type="button" value="Update" onclick="defineAction('update', '<? echo($GLOBALS['cart']) ?>');" />
			...
			?>
                    ...
                    <td><img class="productlistimg" width="100" height="180" src="<? echo(productfolder . $row[0]['productimage']); ?>" /></td>
                    ...
                    <td>
                    <span class="textprice cartprice">
                    	$<? echo($row[0]['price']); ?>
			...
			<? } ?>
                <tr height="10px">
                  ...
                  <td align="right"><span class="textprice cartprice"><Strong>$<? echo(number_format($totalamount,2)) ?></Strong></span></td>
                </tr>
                ...
                <tr height="10px">
                  ...
                  <td align="right"><span class="textprice cartprice"><Strong>$<? echo($tax) ?></Strong></span></td>
                </tr>
                ...
                <tr height="10px">
                  ...
                  <td align="right"><span class="textprice cartprice"><Strong>$<? echo($totalamount) ?></Strong></span></td>
                </tr>
                ...
                <tr height="30px">
                  <td colspan="6" align="right">
                    <input class="button" type="button" value="Continue Shopping" onclick="javascript:window.location='?page=productlist&cart=<? echo($GLOBALS['cart']) ?>'" />
                    <input class="button" type="button" value="Update" onclick="defineAction('update','<? echo($GLOBALS['cart']) ?>')" />
                  	<input class="button" type="button" value="Delete"  onclick="defineAction('delete', '<? echo($GLOBALS['cart']) ?>')" />
                  	<input class="button" type="button" value="Checkout" onclick="defineAction('checkout', '<? echo($GLOBALS['cart']) ?>')" />
                   </td>
                </tr>
                <tr height="10px">
                  <td colspan="6">&nbsp;</td>
