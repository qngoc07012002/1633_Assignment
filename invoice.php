	...
	<div class="productlist">
        ...
        <div class="products">
			...
			<? } ?>
                ...
                <? if($action == 'history'){ ?>
                <input class="button" type="button" value="Back" onclick="javascripr:history.back();" />	
                <? }else{ ?>
                <input class="button" type="button" value="Back" onclick="javascript:window.location='?page=payment&cart=<? echo($GLOBALS['cart']) ?>'" />	
				<input class="button" type="button" value="Finish" onclick="javascript:window.location='?page=finish&cart=<? echo($GLOBALS['cart']) ?>'" />	                <? } ?>
                  </td>
                </tr>
				</table>
          </div>
