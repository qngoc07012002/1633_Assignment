...
<table width="460px" cellpadding="0" cellspacing="0">
    ...
    <td colspan="3" align="right">
        <input class="button" type="button" value="Back" onclick="javascript:window.location='?page=shipment&cart=<? echo($GLOBALS['cart']) ?>'" />        <input class="button" type="button" value="Continue Shopping" onclick="javascript:window.location='?page=productlist&amp;cart=<? echo($GLOBALS['cart']) ?>'" />
        <input class="button" type="button" value="Back to Cart" onclick="javascript:window.location='?page=addcart&cart=<? echo($GLOBALS['cart']) ?>'" />        <input class="button" type="submit" value="Next" />    
        </td>
    </tr>
</table>
</form>
